...
public class ThreadOpen extends ListActivity /*implements AdWhirlInterface*/
{
...
//	private boolean showedAd = false;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setTitle("ChanScan Free - "+chanName+" - "+boardName);
	...
	protected void onResume() {
		super.onResume();
//	    AdWhirlLayout adWhirlLayout = (AdWhirlLayout) findViewById(R.id.adwhirl_thread);
